            ...
            <div class="menu_section">
                ...
                <ul class="nav side-menu">
                 ...
                 <li ><a href="../Stock/" ><i class="fa fa-line-chart"></i>Stock<span ></span></a>
                       ...
                       <li class="current-page"><a href="" ><i class="fa fa-area-chart"></i>Order/Sales<span ></span></a>
                ...
                <div class="x_panel" >
                  ...
                  <div class="x_content" style="display: block;">
                      ...
                      <div class="row">
                        ...
                        <div  style="overflow-y: hidden;overflow-x: auto" class="table" >
                      ...
                      <!---   <th><input type="checkbox" id="check-all" class="flat"></th> --->
                            ...
                            <th class="column-title">List Price </th>
...
if ($result->num_rows > 0)
{
    while ($row = $result->fetch_assoc())
    {
        ...
        echo "<td class=\" \" >" . $row["ListPrice"] . "</td>";
        echo "<td class=\" \" >" . $row["customer_id"] . "</td>";
        echo "</tr>";
    }
                        ...
                        <th class="column-title">VAT</th>
                              ...
                              <?php
                               if($restrict != "Senior Staff"){
                                   ...
                                   echo '<th class="column-title no-link last"><span class="nobr">Action</span>';
                               }
...
if ($result->num_rows > 0)
{
    ...
    echo " <td class='last'>  <button class='btn btn-primary' data-ids3='".$row["ID"] . "' name='btn_deletes' id='btn_deletes' >Delete</button>" ;
                }
...
alert = function() {};
       ...
       $( "#datatable-buttons" ).load( "index.php #datatable-buttons" );
   }
