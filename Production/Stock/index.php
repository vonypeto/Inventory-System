          ...
          <div class="left_col scroll-view">
            ...
            <div class="menu_section">
                ...
                <ul class="nav side-menu">
                 ...
                 <li ><a href="" ><i class="fa fa-line-chart"></i>Stock<span ></span></a>
          ...
          <div class="">
                  ...
                  <div class="x_content">
                    <br />
                      ...
                      <form class="form-label-left input_mask" method="post">
                        ...
                        <div class="col-md-9 col-sm-9 ">
                          <input type="number" class="form-control"  placeholder="Quantity" value="0" name="QTY" id="QTY" required= " ">
                        </div>
                      </div>
                      ...
                      $date = trim($_POST["dates"]);
                          $sql = "insert into newstock(ID,QTY,UPrice)values(?,?,?);";
                            
                          if($stmt = mysqli_prepare($link, $sql)){
                   
                              mysqli_stmt_bind_param($stmt, "sss", $param_id,$param_qty,$param_uprice);
            ...
            mysqli_stmt_close($stmt);
                          ...
                          $name =  $row['Name'];
                                ...
                                $sql = "insert into arcstock(Name,QTY,UPrice,dates)values(?,?,?,?);";
                            
                          if($stmt = mysqli_prepare($link, $sql)){
                   
                              mysqli_stmt_bind_param($stmt, "ssss", $param_name,$param_qty,$param_uprice,$param_date);
                ...
                <div class="x_panel" >
                  ...
                  <div class="x_content" style="display: block;">
                      ...
                      <div class="row">
                        ...
                        <div style="overflow-y: auto;overflow-x: auto"  class="table" id="live_datas">
                      ...
                      <form class="form-label-left input_mask" method="post">
                       <div class="form-group row">
                        <div class="col-md-9 col-sm-9  offset-md-3">
                            ...
                            <button  class="btn btn-success"  name="resupply" id="resupply"  >Supply</button>
                        </div>
...
$(document).on('click', '#resupply', function(){  
