...
if(isset($_POST['oks'])){
    ...
    if(empty(trim($_POST["username"]))){
        ...
        $sql = "SELECT User_ID FROM customer WHERE Username = ?";
    ...
    if(empty($username_err) && empty($password_err) && empty($confirm_password_err)){
        ...
        $sql = "INSERT INTO customer (Username,passwords) VALUES (?, ?)";
...
<div class="center-wrapper">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <div class="form-group">
             ...
             <input type="submit" class="btn btn-primary" value="Submit" id="oks" name="oks">
            </div>
            <p>Already have an account? <a onclick="document.getElementById('id01').style.display='block'"  href="javascript:;">Login here</a>.</p>
        </form>
    </div>    
            </div>
        </div>
